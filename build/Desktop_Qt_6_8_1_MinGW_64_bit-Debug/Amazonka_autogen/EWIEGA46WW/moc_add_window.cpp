...
namespace {
struct qt_meta_tag_ZN10add_windowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10add_windowE = QtMocHelpers::stringData(
    "add_window",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10add_windowE[] = {
...
Q_CONSTINIT const QMetaObject add_window::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10add_windowE.offsetsAndSizes,
    qt_meta_data_ZN10add_windowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10add_windowE_t,
        // Q_OBJECT / Q_GADGET
...
void *add_window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10add_windowE.stringdata0))
